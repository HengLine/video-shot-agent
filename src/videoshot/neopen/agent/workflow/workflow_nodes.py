...
from videoshot.neopen.agent.human_decision.human_decision_intervention import HumanIntervention
from videoshot.neopen.agent.quality_auditor.quality_auditor_models import AuditStatus
from videoshot.neopen.agent.workflow.workflow_models import AgentStage, PipelineNode
from videoshot.neopen.agent.workflow.workflow_states import WorkflowState
from videoshot.neopen.tools.result_storage_tool import create_result_storage
from videoshot.logger import error, debug, info, warning
...
class WorkflowNodes:
    ...
    def _execute_recovery_action(self, action: str, state: WorkflowState,
        ...
        Args:
            ...
            error_analysis: 错误分析结果
        """
        from videoshot.logger import info, warning
